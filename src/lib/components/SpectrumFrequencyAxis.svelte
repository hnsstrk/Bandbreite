...
<g transform="translate(0, {axisY})">
  ...
  <text x="-10" y="5" text-anchor="end" style="fill: var(--color-text-tertiary)" class="text-xs"> f </text>
  {#each ticks as tick (tick)}
    ...
    {#if tickX >= 0 && tickX <= innerWidth}
      <g transform="translate({tickX}, 0)">
        ...
        <text y="20" text-anchor="middle" style="fill: var(--color-text-tertiary); font-size: 10px;">
