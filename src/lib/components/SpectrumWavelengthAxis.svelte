...
<g transform="translate(0, {axisY})">
  ...
  <text x="-10" y="5" text-anchor="end" style="fill: var(--color-text-tertiary)" class="text-xs"> wavelength </text>
  {#each ticks as tick (tick.label)}
    ...
    {#if tickX >= 0 && tickX <= innerWidth}
      <g transform="translate({tickX}, 0)">
        ...
        <text y="-12" text-anchor="middle" style="fill: var(--color-text-tertiary); font-size: 10px;">
          {tick.label}
        </text>
