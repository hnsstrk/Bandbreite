...
export const COMMUNICATION_POINTS: DataPoint[] = [
  ...
  {
    name: '4G/5G Base Station',
    nameDE: '4G/5G Basisstation',
    frequencyHz: 2.6e9,
    powerWatt: 40,
    category: 'communication'
  },
  {
    name: '2G/3G Base Station',
    nameDE: '2G/3G Basisstation',
    frequencyHz: 900e6,
    powerWatt: 20,
    category: 'communication'
  }
