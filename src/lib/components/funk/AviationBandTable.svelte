...
<Card
	title="Frequenzbereiche der Luftfahrt"
	subtitle="Sprechfunk, Navigation, Überwachung und Datenverbindungen"
>
	{#snippet actions()}
	...
	<div class="table-scroll">
		<table>
			<caption>
				Nennwerte nach ICAO Annex 10 und VO Funk Artikel 5. Ein Bereich kann mehreren Diensten
				zugewiesen sein.
			</caption>
			<thead>
				<tr>
