<script lang="ts">
	...
	const groups = MARITIME_HF_FREQUENCIES.reduce<
		{ bandDE: string; entries: typeof MARITIME_HF_FREQUENCIES }[]
	>((acc, entry) => {
...
>
	<div class="table-scroll">
		<table>
			<caption>
				Jedes Band trägt dieselbe Dreiteilung: eine Frequenz für die digitale Alarmierung, eine
				für den anschließenden Sprechverkehr und eine für das Funkfernschreiben.
			</caption>
			<thead>
				<tr>
