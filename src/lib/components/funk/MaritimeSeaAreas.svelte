...
>
	<svg viewBox="0 0 {W} {H}" aria-hidden="true">
		...
		/>
		<text x={segments[2].center} y="24" text-anchor="middle" class="chart-axis-text">
		...
		<text x={segments[3].center} y="64" text-anchor="middle" class="chart-axis-text">
			Kurzwelle trägt allein
		</text>
