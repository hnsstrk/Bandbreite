...
<Card title="Bänder in Deutschland und der EU" subtitle="3GPP-Bandnummern mit Uplink und Downlink">
	...
	<div class="table-scroll">
		<table>
			<caption>
				Frequenzbänder des öffentlichen Mobilfunks. Im Balken liegt der Uplink über dem
				Downlink; bei TDD nutzen beide Richtungen denselben Bereich.
			</caption>
			<thead>
				<tr>
					...
					<tr>
						...
						<td class="cell-bar">
							...
							>
								<span
									class="mini__dl"
									style="left: {dl.leftPercent}%; width: {dl.widthPercent}%"
								></span>
								<span
									class="mini__ul"
									style="left: {ul.leftPercent}%; width: {ul.widthPercent}%"
								></span>
							</span>
						</td>
					</tr>
...
<style>
	...
	.chip--ul { background-color: var(--color-series-1); }
	.chip--dl { background-color: var(--color-series-2); }
