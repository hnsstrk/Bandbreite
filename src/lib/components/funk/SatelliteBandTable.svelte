...
>
	<div class="table-scroll">
		<table>
			<caption>
				Nennbereiche nach VO Funk Artikel 5 und den Bandbuchstaben nach IEEE Std 521. Die
				tatsächlich genutzten Ausschnitte unterscheiden sich je nach Dienst und ITU-Region.
			</caption>
			<thead>
				<tr>
	...
	<p class="note">
		Warum die Aufteilung? Der Satellit hat wenig Sendeleistung und eine begrenzte Kühlung. Er
		bekommt deshalb die niedrigere, schwächer gedämpfte Frequenz für den Abwärtsweg. Die
		Erdfunkstelle kann dagegen mit großer Antenne und viel Leistung arbeiten und übernimmt den
		schwierigeren Aufwärtsweg.
	</p>
</Card>
