...
<svg viewBox="0 0 {VIEW_WIDTH} {VIEW_HEIGHT}" class="spectrum" aria-hidden="true">
	...
	{#each lines as line (line.label)}
		<line x1={xAt(line.offsetHz)} y1={BASELINE_Y} x2={xAt(line.offsetHz)} y2={yAt(line.amplitude)}
	...
	<text x={VIEW_WIDTH - PAD_RIGHT} y={VIEW_HEIGHT - 6} class="axis-label" text-anchor="end">
		Frequenz →
	</text>
</svg>
