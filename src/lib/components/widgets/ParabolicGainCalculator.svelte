<script lang="ts">
	...
	const PRESETS: Preset[] = [
		{ id: 'sat', label: 'Sat-Schüssel 60 cm, 11 GHz', diameterM: 0.6, frequencyHz: 11e9, efficiency: 0.6 },
		{ id: 'effelsberg', label: 'Effelsberg 100 m, 1,4 GHz', diameterM: 100, frequencyHz: 1.4e9, efficiency: 0.5 },
...
<div class="calculator">
	...
	<div class="results">
		...
		<ResultCard
			...
			value={formatNumber(beamwidthDeg, 2)}
			unit="Grad"
			hint="θ ≈ 70° · λ / D"
		/>
	...
	<p class="note">
		Wellenlänge bei {formatFrequency(frequencyHz)}: {formatWavelength(lambda)}. Der Durchmesser
		entspricht {formatNumber(diameterM / lambda, 1)} Wellenlängen.
	</p>
</div>
