...
export type GlossaryCategory =
  'grundlagen' | 'pegel' | 'antennen' | 'ausbreitung' | 'modulation' | 'radar' | 'dienste';
...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  // ==========================================================================
  {
    ...
    term: 'Frequenz',
    short:
      'Zahl der Schwingungen pro Sekunde. Sie bestimmt Wellenlänge, Bauform der Antenne und das Ausbreitungsverhalten.',
  ...
  },
  {
    ...
    term: 'Bandbreite',
    short:
      'Breite des belegten Frequenzbereichs. Sie begrenzt die übertragbare Datenrate und bestimmt, wie viel Rauschen der Empfänger aufnimmt.',
  ...
  },
  {
    ...
    term: 'Polarisation',
    short:
      'Richtung, in der das elektrische Feld einer Welle schwingt — linear (horizontal oder vertikal), zirkular oder elliptisch.',
  ...
  },
  {
    ...
    term: 'Impedanz',
    short:
      'Komplexer Widerstand, den eine Leitung oder Antenne dem Hochfrequenzstrom entgegensetzt. In der Funktechnik meist 50 Ω, in der Antennentechnik des Rundfunks 75 Ω.',
  ...
  },
  {
    ...
    short:
      'Verhältnis von Spannungsmaximum zu Spannungsminimum auf einer fehlangepassten Leitung. 1,0 bedeutet perfekte Anpassung.',
  ...
  },
  {
    ...
    short:
      'Abstand zwischen hinlaufender und reflektierter Welle in dB. Je größer der Wert, desto besser die Anpassung.',
    formula: 'RL = −20 · log₁₀ |Γ|',
    unit: 'dB',
  ...
  },
  {
    ...
    term: 'Skin-Effekt',
    short:
      'Hochfrequente Ströme fließen nur in einer dünnen Randschicht des Leiters; die Skin-Tiefe δ gibt an, wo die Amplitude auf 1/e gefallen ist.',
  ...
  },
  {
    ...
    short:
      'Gesamtheit aller elektromagnetischen Wellen, geordnet nach Frequenz — von den ELF-Wellen über Funk, Licht und Röntgen bis zur Gammastrahlung.',
  ...
  // ==========================================================================
  {
    ...
    term: 'Dezibel (dB)',
    short:
      'Logarithmisches Maß für ein Verhältnis. Leistungen werden mit 10·log₁₀ gezählt, Spannungen und Feldstärken mit 20·log₁₀.',
  ...
  },
  {
    ...
    term: 'dBµV',
    short:
      'Spannungspegel bezogen auf 1 Mikrovolt. Üblich in der Messtechnik, im Rundfunkempfang und bei EMV-Grenzwerten.',
  ...
  },
  {
    ...
    term: 'dBi',
    short:
      'Antennengewinn gegenüber dem isotropen Kugelstrahler — der übliche Bezug in Datenblättern und Regulierung.',
    unit: 'dBi',
  ...
  },
  {
    ...
    term: 'dBd',
    short:
      'Antennengewinn gegenüber dem Halbwellendipol. Er liegt immer 2,15 dB unter derselben Angabe in dBi.',
  ...
  },
  {
    ...
    term: 'ERP',
    short:
      'Abgestrahlte Leistung bezogen auf den Halbwellendipol statt auf den Kugelstrahler; sie liegt 2,15 dB unter der EIRP.',
  ...
  },
  {
    ...
    term: 'Dämpfung',
    short:
      'Verringerung der Signalleistung entlang eines Weges — durch Ausbreitung, Kabel, Bauteile, Regen oder atmosphärische Gase.',
  ...
  },
  {
    ...
    term: 'Link-Budget',
    short:
      'Bilanz aller Gewinne und Verluste einer Funkstrecke vom Sender bis zum Empfänger. Am Ende steht der Empfangspegel gegen die Empfindlichkeit.',
  ...
  },
  {
    ...
    term: 'Rauschflur',
    short:
      'Thermische Rauschleistung im betrachteten Kanal. Bei 290 K sind es −174 dBm je Hertz Bandbreite.',
  ...
  },
  {
    ...
    short:
      'Wie viel schlechter das Signal-Rausch-Verhältnis hinter einer Stufe ist als davor. Ein rauschfreier Verstärker hätte 0 dB.',
  ...
  },
  {
    ...
    short:
      'Rauschen ausgedrückt als äquivalente Temperatur in Kelvin. In der Satelliten- und Radioastronomie üblicher als die Rauschzahl.',
    unit: 'K',
  ...
  },
  {
    ...
    short:
      'Abstand des Nutzsignals vom Rauschen. Er entscheidet, welche Modulation und welche Datenrate möglich sind.',
  ...
  // ==========================================================================
  {
    ...
    short:
      'Gedachte Antenne, die in alle Richtungen gleich stark strahlt. Sie ist der Bezugspunkt für Gewinnangaben in dBi.',
  ...
  },
  {
    ...
    term: 'Antennengewinn',
    short:
      'Wie stark eine Antenne die Leistung in ihre Vorzugsrichtung bündelt — verglichen mit dem Kugelstrahler (dBi) oder dem Dipol (dBd).',
  ...
  },
  {
    ...
    term: 'Dipol',
    short:
      'Der Halbwellendipol ist die Referenzantenne der Funktechnik: 2,15 dBi Gewinn, rund 73 Ω Fußpunktwiderstand.',
  ...
  },
  {
    ...
    short:
      'Richtantenne aus einem gespeisten Element, einem Reflektor und mehreren Direktoren. Typisch 8 bis 16 dBi.',
  ...
  },
  {
    ...
    term: 'Parabolantenne',
    short:
      'Reflektorantenne, die eine ebene Welle im Brennpunkt bündelt. Ihr Gewinn wächst mit der Fläche und mit dem Quadrat der Frequenz.',
  ...
  },
  {
    ...
    term: 'Wirkfläche',
    short:
      'Fläche, aus der eine Empfangsantenne die Leistung der einfallenden Welle aufnimmt. Sie hängt direkt am Gewinn.',
    unit: 'm²',
  ...
  },
  {
    ...
    short:
      'Winkel, innerhalb dessen die abgestrahlte Leistungsdichte auf die Hälfte (−3 dB) des Maximums fällt.',
  ...
  },
  {
    ...
    term: 'Fernfeld',
    short:
      'Bereich ab r = 2D²/λ, in dem sich die Wellenfront als eben beschreiben lässt und die Gewinnangabe gilt.',
  ...
  },
  {
    ...
    short:
      'Viele Einzelstrahler, deren Phasenlage die Keule elektronisch schwenkt — ohne bewegliche Teile.',
  ...
  },
  {
    ...
    term: 'MIMO',
    short:
      'Mehrere Sende- und Empfangsantennen übertragen gleichzeitig getrennte Datenströme über denselben Kanal.',
  ...
  // ==========================================================================
  {
    ...
    term: 'Bodenwelle',
    short:
      'Welle, die der Erdoberfläche folgt. Sie trägt Lang- und Mittelwelle über hunderte Kilometer, verlangt aber vertikale Polarisation.',
  ...
  },
  {
    ...
    term: 'Raumwelle',
    short:
      'Welle, die an der Ionosphäre reflektiert wird und dadurch weit über den Horizont hinaus reicht. Grundlage des Kurzwellenverkehrs.',
  ...
  },
  {
    ...
    short:
      'Direkter Weg zwischen zwei Antennen ohne Hindernis. Ab VHF der übliche Ausbreitungsweg, begrenzt durch den Radiohorizont.',
  ...
  },
  {
    ...
    term: 'Radiohorizont',
    short:
      'Entfernung, bis zu der eine Sichtverbindung über die gekrümmte Erde reicht. Wegen der Refraktion rund 15 % weiter als der optische Horizont.',
  ...
  },
  {
    ...
    short:
      'Krümmung des Strahls durch die mit der Höhe abnehmende Luftdichte. Sie wird als vergrößerter Erdradius k·R gerechnet, im Mittel mit k = 4/3.',
  ...
  },
  {
    ...
    term: 'Fresnel-Zone',
    short:
      'Ellipsoid um die Sichtlinie, in dem sich die Wellen phasenrichtig überlagern. Mindestens 60 % der ersten Zone sollten frei bleiben.',
  ...
  },
  {
    ...
    term: 'Beugung',
    short:
      'Umlenkung der Welle an Kanten und Hindernissen. Sie versorgt Bereiche im Funkschatten, kostet aber Pegel.',
  ...
  },
  {
    ...
    short:
      'Das Signal erreicht den Empfänger über mehrere Wege gleichzeitig. Je nach Phasenlage verstärken oder löschen sich die Anteile.',
  ...
  },
  {
    ...
    term: 'Schwund (Fading)',
    short:
      'Zeitliche Schwankung der Empfangsfeldstärke durch Mehrwegausbreitung, Bewegung oder Wetter.',
  ...
  },
  {
    ...
    term: 'Ionosphäre',
    short:
      'Von der Sonnenstrahlung ionisierte Hochatmosphäre in etwa 60 bis 400 km Höhe. Ihre D-, E- und F-Schichten prägen die Kurzwellenausbreitung.',
  ...
  },
  {
    ...
    term: 'MUF',
    short:
      'Maximum Usable Frequency: die höchste Frequenz, die für eine bestimmte Strecke noch von der Ionosphäre zurückkommt.',
  ...
  },
  {
    ...
    term: 'LUF',
    short:
      'Lowest Usable Frequency: die niedrigste Frequenz, die trotz Absorption in der D-Schicht noch mit brauchbarem Pegel ankommt.',
  ...
  },
  {
    ...
    short:
      'Ring zwischen der Reichweite der Bodenwelle und dem ersten Auftreffpunkt der Raumwelle — dort ist kein Empfang möglich.',
  ...
  },
  {
    ...
    term: 'Sporadic E',
    short:
      'Unregelmäßig auftretende, stark ionisierte Wolken in der E-Schicht. Sie ermöglichen im Sommer VHF-Verbindungen über 1000 bis 2000 km.',
  ...
  },
  {
    ...
    term: 'Troposcatter',
    short:
      'Streuung an Inhomogenitäten der Troposphäre. Sie erlaubt Verbindungen über einige hundert Kilometer weit jenseits des Horizonts.',
  ...
  },
  {
    ...
    term: 'Ducting',
    short:
      'Führung der Welle in einer atmosphärischen Schicht wie in einem Hohlleiter. Über See sind dadurch Überreichweiten von vielen hundert Kilometern möglich.',
  ...
  },
  {
    ...
    term: 'Gasdämpfung',
    short:
      'Absorption durch Sauerstoff und Wasserdampf. Sie erzeugt die bekannten Spitzen bei 22 GHz, 60 GHz und 183 GHz.',
  ...
  // ==========================================================================
  {
    ...
    term: 'Modulation',
    short:
      'Aufprägen einer Nachricht auf eine Trägerschwingung durch Änderung von Amplitude, Frequenz oder Phase.',
  ...
  },
  {
    ...
    short:
      'Die Amplitude des Trägers folgt dem Nutzsignal. Einfach zu demodulieren, aber empfindlich gegen Störungen und wenig leistungseffizient.',
  ...
  },
  {
    ...
    short:
      'Die Momentanfrequenz folgt dem Nutzsignal. Unempfindlich gegen Amplitudenstörungen, dafür breitbandiger als AM.',
  ...
  },
  {
    ...
    short:
      'AM ohne Träger und ohne ein Seitenband. Halbe Bandbreite, deutlich bessere Leistungsausnutzung — Standard im Kurzwellen-Sprechfunk.',
  ...
  },
  {
    ...
    term: 'FSK',
    short:
      'Frequenzumtastung: jedes Symbol entspricht einer festen Frequenz. Robust und einfach, deshalb bei Telemetrie und Funkfernsteuerungen verbreitet.',
  ...
  },
  {
    ...
    term: 'PSK',
    short:
      'Phasenumtastung: die Information steckt in der Phasenlage des Trägers. BPSK überträgt ein Bit je Symbol, QPSK zwei.',
  ...
  },
  {
    ...
    term: 'QAM',
    short:
      'Quadraturamplitudenmodulation: Amplitude und Phase tragen gemeinsam die Information. 64-QAM überträgt 6 Bit je Symbol.',
  ...
  },
  {
    ...
    term: 'OFDM',
    short:
      'Aufteilung des Datenstroms auf viele orthogonale Unterträger. Robust gegen Mehrwegausbreitung, deshalb Basis von WLAN, LTE, 5G, DAB+ und DVB-T2.',
  ...
  },
  {
    ...
    term: 'Spreizspektrum',
    short:
      'Das Signal wird absichtlich über eine viel größere Bandbreite verteilt, als die Datenrate erfordert — durch Codespreizung oder Frequenzsprünge.',
  ...
  },
  {
    ...
    term: 'Symbolrate',
    short:
      'Zahl der übertragenen Symbole je Sekunde, gemessen in Baud. Mit der Zahl der Bit je Symbol ergibt sich daraus die Bitrate.',
    unit: 'Bd',
  ...
  },
  {
    ...
    short:
      'Anteil falsch empfangener Bits. Sie ist das Qualitätsmaß digitaler Übertragung und hängt unmittelbar am SNR.',
  ...
  },
  {
    ...
    term: 'Kanalkapazität',
    short:
      'Obergrenze der fehlerfrei übertragbaren Datenrate nach Shannon-Hartley — bestimmt durch Bandbreite und Signal-Rausch-Verhältnis.',
  ...
  },
  {
    ...
    term: 'Duplex',
    short:
      'Art, wie Hin- und Rückrichtung getrennt werden: FDD über getrennte Frequenzen, TDD über getrennte Zeitschlitze.',
  ...
  },
  {
    ...
    short:
      'Wie sich mehrere Teilnehmer einen Kanal teilen: nach Frequenz (FDMA), Zeit (TDMA), Code (CDMA) oder Unterträgern (OFDMA).',
  ...
  // ==========================================================================
  {
    ...
    term: 'Radar',
    short:
      'Ortung durch Aussenden eines Signals und Auswerten der Rückstreuung. Aus Laufzeit, Richtung und Frequenzverschiebung folgen Entfernung, Winkel und Geschwindigkeit.',
  ...
  },
  {
    ...
    short:
      'Fläche, die ein Ziel dem Radar scheinbar entgegenstellt. Sie hängt von Form, Material, Frequenz und Blickwinkel ab, nicht nur von der Größe.',
  ...
  },
  {
    ...
    short:
      'Zahl der Sendeimpulse je Sekunde. Sie legt die eindeutige Maximalreichweite fest: R = c / (2 · PRF).',
  ...
  },
  {
    ...
    term: 'Doppler-Effekt',
    short:
      'Frequenzverschiebung durch Relativbewegung. Sie macht die Radialgeschwindigkeit eines Ziels messbar.',
  ...
  },
  {
    ...
    term: 'FMCW-Radar',
    short:
      'Dauerstrichradar mit frequenzmoduliertem Träger. Aus der Differenzfrequenz zwischen gesendetem und empfangenem Signal folgt die Entfernung.',
  ...
  },
  {
    ...
    term: 'Sekundärradar',
    short:
      'Das Ziel antwortet aktiv auf eine Abfrage. In der Luftfahrt fragt der Bodenradar auf 1030 MHz, der Transponder antwortet auf 1090 MHz.',
  ...
  },
  {
    ...
    short:
      'Ein langer, modulierter Sendepuls wird im Empfänger zusammengeschoben. Das bringt Reichweite eines langen und Auflösung eines kurzen Pulses.',
  ...
  },
  {
    ...
    term: 'Frequenzplan',
    short:
      'Verzeichnis, welcher Funkdienst welchen Bereich nutzen darf. International legt die ITU den Rahmen fest, national die Bundesnetzagentur.',
  ...
  },
  {
    ...
    term: 'ISM-Band',
    short:
      'Bereiche für industrielle, wissenschaftliche und medizinische Anwendungen — genehmigungsfrei nutzbar, aber ohne Störungsschutz.',
  ...
  },
  {
    ...
    short:
      'Funkanwendungen geringer Reichweite und Leistung, die allgemein zugeteilt sind — Fernbedienungen, Sensoren, Reifendrucküberwachung.',
  ...
  },
  {
    ...
    term: 'PMR446',
    short:
      'Genehmigungsfreier Betriebsfunk auf 446 MHz mit 500 mW ERP und fest eingebauter Antenne.',
  ...
  },
  {
    ...
    term: 'LPD433',
    short:
      'Kurzstreckenfunk im 433-MHz-ISM-Band mit 10 mW ERP — genutzt von Fernbedienungen, Wetterstationen und einfachen Sprechfunkgeräten.',
  ...
  },
  {
    ...
    short:
      'Funkdienst zur Selbstbildung, für technische Experimente und den internationalen Verkehr — mit eigenen Bändern, Prüfung und Rufzeichen.',
  ...
  },
  {
    ...
    term: 'GMDSS',
    short:
      'Weltweites Seenotfunksystem: automatische Alarmierung über UKW, Grenz- und Kurzwelle sowie Satellit statt Dauerhörwache.',
  ...
  },
  {
    ...
    short:
      'Digitales Rufverfahren im Seefunk. Kanal 70 im UKW-Bereich ist ausschließlich für DSC-Alarmierung reserviert.',
  ...
  },
  {
    ...
    short:
      'Satellitengestützte Notfunkbaken senden auf 406 MHz an das Cospas-Sarsat-System; 121,5 MHz dient nur noch der Nahfeldpeilung.',
    related: ['#gmdss', '/wissen/funktechnik/notfrequenzen/'],
    category: 'dienste',
  ...
  },
  {
    ...
    term: 'ADS-B',
    short:
      'Flugzeuge senden ihre per Satellitennavigation bestimmte Position selbsttätig auf 1090 MHz aus — ohne Abfrage durch ein Radar.',
  ...
  },
  {
    ...
    term: 'TETRA',
    short:
      'Digitaler Bündelfunkstandard für Behörden und Betriebe. In Deutschland trägt er den BOS-Digitalfunk im 380-bis-395-MHz-Bereich.',
  ...
  },
  {
    ...
    term: 'DAB+',
    short:
      'Digitaler terrestrischer Hörfunk im VHF-Band III. Mehrere Programme teilen sich einen Multiplex von 1,536 MHz Bandbreite.',
  ...
  },
  {
    ...
    short:
      'Mehrere Sender strahlen dasselbe Signal zeitgleich auf derselben Frequenz ab. Möglich wird das durch OFDM mit Schutzintervall.',
...
export const GLOSSARY_LETTERS: string[] = [...new Set(GLOSSARY_SORTED.map(glossaryLetter))].sort(
