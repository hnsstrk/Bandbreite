...
export const HISTORICAL_EVENTS: HistoricalEvent[] = [
  ...
  },
  {
    ...
    titleDE: 'Erste transatlantische Uebertragung',
    description: 'Marconi transmits letter "S" across the Atlantic Ocean',
    descriptionDE: 'Marconi uebertraegt den Buchstaben "S" ueber den Atlantik',
    category: 'invention',
    frequencyHz: 850e3,
    person: 'Guglielmo Marconi',
  ...
  },
  {
    ...
    descriptionDE: 'Funk rettet 700 Leben; fuehrt zu Funkpflicht auf Schiffen',
    category: 'invention',
    frequencyHz: 500e3,
    significance: 'major'
  },
  {
    ...
    descriptionDE: 'Lee de Forest erfindet die Audionroehre, erste Verstaerkerroehre',
    category: 'invention',
  ...
  // Mobile Communications
  {
    ...
    descriptionDE: 'Martin Cooper fuehrt erstes Gespraech mit Handy',
    category: 'mobile',
    frequencyHz: 850e6,
  ...
  },
  {
    ...
    descriptionDE: 'GPS-System wird fuer voll betriebsbereit erklaert',
    category: 'satellite',
  ...
  },
  {
    ...
    descriptionDE: 'LoRaWAN fuer IoT standardisiert',
    category: 'digital',
    frequencyHz: 868e6,
    significance: 'moderate'
  }
