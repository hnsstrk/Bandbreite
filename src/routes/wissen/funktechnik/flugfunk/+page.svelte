...
>
	<Callout tone="warning" title="Lernhilfe, kein Betriebsdokument">
		Diese Seite erklärt die Technik. Verbindlich sind das Luftfahrthandbuch AIP, die
		Veröffentlichungen der Flugsicherung und die ICAO-Dokumente. Der Betrieb einer Funkanlage im
		Flugfunkband setzt eine Zulassung und ein gültiges Sprechfunkzeugnis voraus.
	</Callout>
