...
>
  <Callout tone="warning" title="Lernhilfe, kein Betriebsdokument">
    Diese Seite erklärt Aufbau und Technik des Seefunks. Für den tatsächlichen Betrieb gelten ausschließlich die
    amtlichen Veröffentlichungen — Vollzugsordnung für den Funkdienst, Nachrichten für Seefahrer, ITU-Listen der Küsten-
    und Schiffsfunkstellen sowie die Verfügungen der Bundesnetzagentur. Aussendungen auf Not- und Anruffrequenzen ohne
    Notfall sind strafbar.
  </Callout>
